...
class VideoDetail extends Component {
    render() {
        const { name, url, desc, attr, time } = this.props.location.state.video
        const titleHead = (
            <span>
                <LinkButton>
                    <Icon
        ...
        return (
            <Card title={titleHead} >
                <Item className='article-detail'>
                    <span className='left'>视频名：</span>
                    <span>{name}</span>
                </Item>
                <Item>
                    <span className='left'>视频描述：</span>
                    <span>{desc}</span>
                </Item>
                <Item>
                    <span className='left'>视频分类：</span>
                    <span>{attr}</span>
                </Item>
                <Item>
